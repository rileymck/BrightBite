...
class DentureCarePage extends StatefulWidget {
  const DentureCarePage({super.key});

  @override
  _DentureCarePageState createState() => _DentureCarePageState();
}
class _DentureCarePageState extends State<DentureCarePage> {
  ...
  Future<void> _toggleFavorite() async {
    ...
    if (isFavorite) {
      ...
      final newItem = FavoriteItem(
        id: 'denture_care',
        name: 'Denture Care',
        imageUrl: 'assets/images/elderly_people.png', 
      );
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/images/elderly_people.png', width: 60, height: 60,),
