...
class CompositeFillingsPage extends StatefulWidget {
  ...
  @override
  _CompositeFillingsPageState createState() => _CompositeFillingsPageState();
}

class _CompositeFillingsPageState extends State<CompositeFillingsPage> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "Ever wondered what happens when you get a filling? This video breaks down the step-by-step process of composite (white) fillings, so you know exactly what to expect when fixing a cavity.",
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                  height: 1.4,
