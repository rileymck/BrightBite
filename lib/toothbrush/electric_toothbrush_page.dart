...
class ElectricToothbrushPage extends StatefulWidget {
  const ElectricToothbrushPage({super.key});

  @override
  _ElectricToothbrushPageState createState() => _ElectricToothbrushPageState();
}
class _ElectricToothbrushPageState extends State<ElectricToothbrushPage> {
  ...
  Future<void> _checkIfFavorite() async {
    ...
    final favorite = box.values.cast<FavoriteItem>().firstWhere(
        (item) => item.id == 'electric_toothbrush_page',
  ...
  Future<void> _toggleFavorite() async {
    ...
    if (isFavorite) {
      ...
      final newItem = FavoriteItem(
        id: 'electric_toothbrush_page',
        name: 'Electric',
        imageUrl: 'assets/images/electric_toothbrush.png', 
      );
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/images/electric_toothbrush.png', width: 60, height: 60,),
