...
class OralProbioticsPage extends StatefulWidget {
  const OralProbioticsPage({super.key});

  @override
  _OralProbioticsPageState createState() => _OralProbioticsPageState();
}
class _OralProbioticsPageState extends State<OralProbioticsPage> {
  ...
  Future<void> _toggleFavorite() async {
    ...
    if (isFavorite) {
      ...
      final newItem = FavoriteItem(
        ...
        imageUrl: 'assets/images/other_treatment.png', 
      );
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/images/other_treatment.png', width: 60, height: 60,),
