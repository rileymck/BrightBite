...
class TongueScrapersPage extends StatefulWidget {
  const TongueScrapersPage({super.key});

  @override
  _TongueScrapersPageState createState() => _TongueScrapersPageState();
}
class _TongueScrapersPageState extends State<TongueScrapersPage> {
  ...
  Future<void> _toggleFavorite() async {
    ...
    if (isFavorite) {
      ...
      final newItem = FavoriteItem(
        id: 'tounge_scrapers',
        name: 'Tounge Scrapers',
        imageUrl: 'assets/images/tongue_cleaner.png', 
      );
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/images/tongue_cleaner.png', width: 60, height: 60,),
